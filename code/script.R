...
# load packages needed in one go. You should have pacman and other packages installed beforehand. 
...
library(ggplot2)
ggplot(pc_2, aes(PC1, PC2, col = trt, fill = sp)) + # fill = sp, or as or cd, is to group using diff factors
